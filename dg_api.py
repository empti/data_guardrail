...
# The API endpoint is: /dg/api/v0.1/classify

@app.route('/dg/api/v0.1/classify', methods=['GET'])
def get_handling():
...
@app.route('/dg/api/v0.1/classify', methods=['POST'])
def process_data():
...
if __name__ == '__main__':
    app.run(host='0.0.0.0', debug=True, port=6155)
